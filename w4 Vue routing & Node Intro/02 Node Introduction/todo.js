...
var items = []
// const items = [] // it still works because we manipulate the array, not reassign it
...
do {
  ...
  // let input = String(readline.question('enter command: ')) : do not work, input is not defined in while loop
  // const input = String(readline.question('enter command: '))  : do not work, input is not defined in while loop
